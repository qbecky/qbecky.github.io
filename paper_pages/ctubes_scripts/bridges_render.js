...
const container = document.getElementById('bridges-viewer');
...
const modelPaths = [
    '../papers/ctubes/models/bridges/bridge_directrix_distance.obj',
    '../papers/ctubes/models/bridges/bridge_directrix_alignment.obj',
];
const modelColors = [
    0xF0BE78,
    0x049ef4,
    ...
    loader.load(
        ...
        function ( object ) {
            ...
            if (setCamera) {
                ...
                camera.position.set(boxSizes.x, 0, 2.0 * boxSizes.z);
...
loadModel(modelPaths[0], objectMaterial1, 0, -5, true);
loadModel(modelPaths[1], objectMaterial2, 0, 5, false);
