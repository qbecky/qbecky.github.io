...
const container = document.getElementById('torus-viewer');
...
const modelPaths = [
    '../papers/ctubes/models/torus_comparison/ours_ratio0.205_opt_tube_obj_slipt_strips.obj',
    '../papers/ctubes/models/torus_comparison/ours_ratio0.200_opt_tube_obj_slipt_strips.obj',
    '../papers/ctubes/models/torus_comparison/maekawa_scholz_ratio0.205_tube_obj_slipt_strips.obj',
    '../papers/ctubes/models/torus_comparison/maekawa_scholz_ratio0.200_tube_obj_slipt_strips.obj',
];
const modelColors = [
    0x049ef4,
    0x049ef4,
...
gui.title('Controls');
gui.close();
const params = {modelName: "Ours r=0.205"};
...
const modelNameController = gui.add(params, 'modelName',{
    "Ours r=0.205": 0,
    "Ours r=0.200": 1,
    "[Maekawa and Scholz 2024] r=0.205": 2,
    "[Maekawa and Scholz 2024] r=0.200": 3,
}).name('Model');
modelNameController.onChange((value) => {
    ...
    objectMaterial.color.set(modelColors[value]);
    objectMaterial.needsUpdate = true;
});
