...
const container = document.getElementById('nonplanar-viewer');
...
const modelPaths = [
    '../papers/ctubes/models/nonplanar_v/mtube.obj',
    '../papers/ctubes/models/nonplanar_v/ctube_planar.obj',
    '../papers/ctubes/models/nonplanar_v/ctube_nonplanar.obj',
];
const modelColors = [
    0x049ef4,
    0x049ef4,
...
function loadModel(modelPath) {
    loader.load(
        ...
        function ( object ) {
            ...
            camera.position.set(boxSizes.x, 1.5 * boxSizes.y, 1.5 * boxSizes.z);
