...
The main gulp command is `gulp dev` which starts an http server. When python or sass files are changed, they are recompiled. Note that you may need to run `npm install` the first time you run the gulp command.
